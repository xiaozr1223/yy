...
"><i class="article"></i><em>会员管理</em></a></li>
 ...
 <div id="dcMain">
   <!-- 当前位置 -->
<div id="urHere">MOOC 管理中心<b>></b><strong>登录记录</strong> </div>   <div id="manager" class="mainBox" style="height:auto!important;height:550px;min-height:550px;">        
 ...
 $sql="select * from tb_admin limit $offset,$Page_size";
